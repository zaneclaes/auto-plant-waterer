...
// ---- VL53L0X driver instance ----
static espp::Vl53l* s_vl53l = nullptr;

// ---- Small helpers: adapt ESP-IDF I2C master calls to espp::Vl53l callbacks ----
static bool vl53l_i2c_write(uint8_t addr, const uint8_t* data, size_t len) {
  // addr is 7-bit (0x29 default)
  esp_err_t err = i2c_master_write_to_device(
      I2C_PORT, addr, data, len, pdMS_TO_TICKS(50));
  return err == ESP_OK;
}

static bool vl53l_i2c_read(uint8_t addr, uint8_t* data, size_t len) {
